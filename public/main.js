...
/* harmony import */ var _pipe_search_pipe__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./pipe/search.pipe */ "./src/app/pipe/search.pipe.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _pipe_search_pipe__WEBPACK_IMPORTED_MODULE_11__["SearchPipe"]
            ],
            imports: [
...
var NavBarComponent = /** @class */ (function () {
    ...
    NavBarComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.subscription = this.searchBox.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(200)).subscribe(function (term) {
    ...
    NavBarComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_input_service__WEBPACK_IMPORTED_MODULE_4__["InputService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]])
    ], NavBarComponent);
...
var DEFAULT_PROBLEM = Object.freeze({ id: 0,
    name: '',
    desc: '',
    difficulty: 'easy'
});
...
var ProblemListComponent = /** @class */ (function () {
    ...
    ProblemListComponent.prototype.getSearchTerm = function () {
        ...
        this.subscriptionInput = this.inputService.getInput()
            .subscribe(function (inputTerm) { return _this.searchTerm = inputTerm; } // 这个地方不加括号为什么就可以
        );
    };
...
var SearchPipe = /** @class */ (function () {
    ...
    SearchPipe.prototype.transform = function (problems, term) {
        ...
        console.log(term);
        return problems.filter(function (problems) {
            return problems.name.toLowerCase().includes(term);
        } //todo: 这里加上大括号和没有大括号是否一样? =>加上就不显示list了
        );
    };
...
var CollaborationService = /** @class */ (function () {
    function CollaborationService() {
        this._allCoders = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
    }
    CollaborationService.prototype.onInit = function (editor, sessionId) {
        var _this = this;
        ...
        this.collaborationSocket.on("coderChange", function (data) {
            console.log('current coders in this session is:' + data);
            _this._allCoders.next(data.toString());
        });
...
var DataService = /** @class */ (function () {
    function DataService(httpClient) {
        ...
        this._problemResource = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]([]);
    }
    ...
    DataService.prototype.getProblems = function () {
        ...
        this.httpClient.get('api/v1/problems') //get will return an observable
            .toPromise()
            .then(function (res) {
            _this._problemResource.next(res);
        })
    ...
    DataService.prototype.addProblem = function (problem) {
        var _this = this;
        var option = { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/json' }) };
...
var InputService = /** @class */ (function () {
    function InputService() {
        this.inputSubject$ = new rxjs_internal_BehaviorSubject__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"]('');
    }
...
module.exports = __webpack_require__(/*! /Users/shuyanli/Desktop/BitTiger-CS503-1803/week3/oj-client/src/main.ts */"./src/main.ts");
